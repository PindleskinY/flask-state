...
class LoggingWrap:
    ...
    def warning(self, msg, *args, **kwargs):
        if (
            ...
            and callable(self.logger.warning)
        ):
    ...
    def debug(self, msg, *args, **kwargs):
        if (
            ...
            and callable(self.logger.debug)
        ):
    ...
    def exception(self, msg, *args, exc_info=False, **kwargs):
        if (
            ...
            and callable(self.logger.exception)
        ):
...
class DefaultLogger:
    def __init__(self):
        ...
        log_format = (
            ...
            + DefaultLogger.red("| ")
            + DefaultLogger.yellow("%(levelname)s ")
            + DefaultLogger.red("| ")
